      ...
      <div className="main-page__content">
        <div className="registration-block">
          <div className="registration-block__content">
            <input className="registration-input-form" placeholder="Фамилия" style={{marginTop: '29px'}}/>
            <input className="registration-input-form" placeholder="Имя"/>
            <input className="registration-input-form" placeholder="Отчество" />
            <input className="registration-input-form" placeholder="Населённый пункт образовательного учреждения" />
            <input className="registration-input-form" placeholder="Наименование образовательного учреждения" />
        ...
        <div className="registration-block-shadow">
