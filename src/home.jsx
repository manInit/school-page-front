...
export const trajectory_btn = <Button link='/trajectory_list' className='trajectory_btn' value='Направления'/>
export const personal_space_btn = <Button link='/personal' value='Личный кабинет' style={{marginLeft: 'auto'}} />
export const user_fi = <span className="user_fi">Имя Фамилия</span>
export const register_btn = <Button link='/register' value='Регистрация' style={{marginLeft: 'auto'}} />
